...
// Toggle between light and dark theme settings only (no "system" state).
...
// Default is "light" (no "system" state on this site).
...
let initTheme = () => {
  ...
  // No system-preference listener — this site uses an explicit light/dark toggle only.
};
